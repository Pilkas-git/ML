...
def create_model(num_classes):
    ...
    roi_pooler = ops.MultiScaleRoIAlign(featmap_names=['0','1','2','3'],  # roi pooling in which resolution feature
    ...
    rpn_head = RPNHead(in_channels=model.backbone.out_channels, num_anchors=anchor_generator.num_anchors_per_location()[0])
